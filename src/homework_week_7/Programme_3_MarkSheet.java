...
public class Programme_3_MarkSheet {
    public static void main(String[] args) {
        ...
        String results = calculateResults(mathsMarks,scienceMarks,englishMarks);
        String grade = calculatingGrade(percentage, results);
        printTheMarkSheet(name, rollNum,mathsMarks, scienceMarks,englishMarks,total,percentage,results,grade);
    ...
    public static String calculateResults(int mathMarks, int scienceMarks, int englishMarks){
    ...
    public static String calculatingGrade(int percentage, String result){
        String grade = null;
